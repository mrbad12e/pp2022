...
{
    return genericGetStringList(CMD_GET_PERSON_VARIABLE, "", ID_LIST,
 RESPONSE_GET_PERSON_VARIABLE);
}
Coord TraCICommandInterface::getPersonPosition(std::string personId)
{
    return genericGetCoord(CMD_GET_PERSON_VARIABLE, personId, VAR_POSITION,
RESPONSE_GET_PERSON_VARIABLE);
}
